...
# run for era UL2018 (Data_mu + MC_mu), tag "earlySeptember", full ABCD treatment.
#
# Purpose: smoke-test the pipeline (additional-lepton veto included) against
# earlySeptember/UL2018 before committing to the full-statistics run. Unlike
...
# disk for all 27 MC datasets (003-ObjectSelectionII/inputs/SFs/Efficiency/UL2018
# and .../JetPUID/Efficiency/UL2018), computed under an earlier tag from the
# same underlying MC content.
#
# Usage: bash run_earlySeptember_UL2018_sample.sh
...
log "Reusing existing UL2018 b-tagging/jetPUID efficiency maps (not recomputed for this sample run)."
