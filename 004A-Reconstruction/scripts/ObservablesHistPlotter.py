#!/usr/bin/env python3
"""
ObservablesHistPlotter.py - Plot Data/MC distributions for ttbar physics observables

Reads .coffea files produced by ObservablesDataMCHist.py and creates stacked Data/MC plots
with ratio panels for the 7 physics observables from observables.py.
...
# --- Variable Configuration for Physics Observables ---
...
def main():
    ...
    try:
        ...
        if args.sample_info is None:
            ...
            args.sample_info = os.path.join(script_dir, '..', 'configs', f'{tag}_{era}_observables_lumiXinfo.json')
