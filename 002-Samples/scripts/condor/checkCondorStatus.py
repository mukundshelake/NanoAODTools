#!/usr/bin/env python3
"""
002-Samples/scripts/condor/checkCondorStatus.py
==================================================
Check status of HTCondor preselection jobs submitted via
submit_preselection_condor.py, for a given work area.
...
def main():
    parser = argparse.ArgumentParser(description="Check status of condor preselection jobs.")
