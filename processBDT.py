...
if __name__ == "__main__":
    ...
    for DataMC in dicti:
        for key in dicti[DataMC]:
            outDir = f'/mnt/disk1/skimmed_Run2/BDT/{outputTag}/{era}/{DataMC}/{key}' # Use outputTag and era
            input_files = dicti[DataMC][key]
            dataset_list.append((DataMC, key, input_files, outDir)) # Add era to tuple
