...
# UL2017 (Data_mu + MC_mu), tag "earlySeptember" -- full ABCD treatment,
# following the --sample smoke test (run_earlySeptember_UL2017_sample.sh)
# that verified the pipeline (including the additional-lepton veto) runs
# cleanly against earlySeptember/UL2017.
#
...
#
# Usage: bash run_earlySeptember_UL2017_fullABCD.sh
...
log "Reusing existing UL2017 b-tagging/jetPUID efficiency maps (not recomputed for this run)."
