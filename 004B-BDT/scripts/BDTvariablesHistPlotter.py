#!/usr/bin/env python3
"""
BDTvariablesHistPlotter.py - Plot Data/MC distributions for BDT variables

Reads .coffea files produced by BDTvariablesDataMCHist.py and creates stacked Data/MC plots
with ratio panels for the 17 BDT variables from BDTvariableModule.py.
...
Usage:
    python scripts/BDTvariablesHistPlotter.py outputs/midNov_UL2017_bdtvariables.coffea
"""
...
def main():
    ...
    try:
        ...
        if args.sample_info is None:
            ...
            args.sample_info = os.path.join(script_dir, '..', 'configs', f'{tag}_{era}_bdtvariables_lumiXinfo.json')
